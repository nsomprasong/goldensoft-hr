...
export default async function HrSettingsPage() {
  ...
  const links = [["/hr/settings/departments","แผนก"],["/hr/settings/positions","ตำแหน่ง"],["/hr/settings/shifts","กะงาน"],["/hr/settings/overtime-rules","กฎ OT"],["/hr/settings/payroll-schedules","รอบจ่าย"],["/hr/settings/leave-entitlements","สิทธิ์วันลา"],["/hr/locations","สถานที่ทำงาน"],["/hr/calendars","ปฏิทินทำงาน"]];
