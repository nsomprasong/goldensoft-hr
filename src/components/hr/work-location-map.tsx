  ...
  return (
    <div className="hr-location-map">
      ...
      <p className="muted hr-location-map-hint">
        {disabled
          ? "แผนที่แสดงจุดลงเวลาและรัศมี GPS"
          : hasPin
            ? "ลากหมุดหรือคลิกบนแผนที่เพื่อย้ายจุด — วงกลมคือรัศมีที่อนุญาตให้ลงเวลา"
            : "คลิกบนแผนที่เพื่อเลือกจุดลงเวลา หรือกดใช้ตำแหน่งปัจจุบัน"}
      </p>
    </div>
  );
}
